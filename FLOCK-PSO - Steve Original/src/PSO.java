	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int functionNum = 0 ; functionNum < doFunction.length ; ++functionNum) {
				...
				if (runsDataFileNeeded) {
					runsDataFile.close();
					mannWhitney(runsDataFileName, totalNumRuns, folder, functionNum, dateString);
				}
...
//		return typeOfTest.substring(1);
	...
	public static void mannWhitney(String runsDataFileName, int numRuns, String folder, int functionNum, String dateString) {
